...
{
    [Authorize(Roles ="Admin")] //sadece Admin olan kullanıcılar buradaki sayfaları görebilir
    public class RoleAdminController : Controller
    {
        ...
        public ActionResult Delete(string id)
        {
            ...
            if (role != null)
            {
                ...
                {
                    return View("Error", result.Errors); //Yeni bir View oluşturuyorum
                }
            }
            else
            {
        ...
        public ActionResult Edit(string id)
        {
            ...
            foreach (var user in userManager.Users.ToList())
            {
                ...
                list.Add(user); //eğer yukarıda user role'ün içerisinde ise members'a eklenir değilse nonMembers'a eklenir. Dinamik bir yapı oluşturduk
            }
